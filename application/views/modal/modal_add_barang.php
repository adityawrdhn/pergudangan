...
<div id="modalAddBarang" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <form class="form-horizontal" method="post" action="<?php echo site_url('master_pergudangan/tambah_barang')?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="stok" type="text" value="0" lass="uneditable-input" readonly="true">
                </div>
            </div>
