...
<div align="center">
    <h3 style="border: 1px solid #333;">Report Pembelian Barang</h3>
    <br/>
    <div align="left">
        <table>
            <?php if(isset($dt_pembelian)){ foreach($dt_pembelian as $row) { ?>
                <tr>
                    <td width="65%"><strong>Kode Pembelian : </strong> <?php echo $row->kd_pembelian; ?></td>
                    <td style="float: right"><strong>Supplier : </strong> <?php echo $row->nm_supplier; ?></td>
                </tr>
                <tr>
                    <td width="65%"><strong>Tanggal Pembelian : </strong> <?php echo date("d M Y",strtotime($row->tanggal_pembelian));?></td>
