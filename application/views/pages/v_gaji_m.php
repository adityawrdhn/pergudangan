...
<div class="container spacer" >
    <h2 class="center" style="margin-bottom:0px; text-align: center;">Permohonan Gaji Pegawai</h2></br>
                                ...
                                if (isset($tb_gaji)) {
                                    foreach ($tb_gaji as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-mini" href="<?php echo site_url('gaji/terima/' . $row->kd_gaji); ?>"
                                                   onclick="return confirm('Anda yakin menerima pengajuan gaji saudara <?php echo $row->nama; ?> ?')">YA</a>                 	
                                            		
                                                <a class="btn btn-mini" href="<?php echo site_url('gaji/tolak/' . $row->kd_gaji); ?>"
                                                   onclick="return confirm('AAnda yakin menolak pengajuan gaji saudara <?php echo $row->nama; ?> ?')">TIDAK</a>                 	
                                            </td> 
